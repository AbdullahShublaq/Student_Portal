        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="header">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <p class="category">Here is a grades of your courses</p>
                                    </div>
                                    <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3>Semester Average : <span id="avg"></span> </h3>
                        </div>
                        <div class="col-md-12">
                            <h3>GPA : <span></span> <?php echo $student->getGpa() ?></h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function (e) {
        ...
        function get_average(student) {
            $.ajax({
                ...
                success: function (data) {
                    $('#avg').html('');
                    $('#avg').append('<span>'+data[0]["avg"]+'</span>');
                },
                error: function (data, textStatus) {
                    swal("Failed!", "Some Thing Is Error!", "error");
                }
